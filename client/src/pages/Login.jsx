      ...
      <div className="login-split">
        ...
        <div className="login-left">
          ...
          <div className="login-hero" style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p>A production-grade health platform bridging the gap between patients, caregivers, and medical professionals.</p>
          </div>
        ...
        <div className="login-right">
          <div className="login-form-wrap">
            ...
            <p className="login-form-sub">Sign in to your secure portal to continue</p>
